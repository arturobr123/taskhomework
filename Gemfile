...
#forma diferente de escribir HTML
gem 'haml-rails'
...
#paperclip para subir archivos (CV)
gem "paperclip" ,"~> 5.0.0beta1"

#para cobros en linea
gem 'stripe'

#gem sidekiq para backend de los trabajos en 2do plano
gem 'sidekiq'
#el servidor con el que corre sidekiq
